                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-brand">
                        <div class="footer-logo-section">
                            <img src="<?= APP_URL ?>/logo1.png" alt="BaronCast Logo" class="footer-logo">
            ...
            <div class="footer-container">
                <div class="footer-bottom-content">
                    <div class="copyright">
                        ...
                        <p class="made-with">Made with <i class="fas fa-heart text-danger"></i> in Ghana 🇬🇭</p>
                    </div>
