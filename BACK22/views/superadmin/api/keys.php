                ...
                <tbody>
                    ...
                    $sampleKeys = [
                        [
                            'id' => 1,
                            'name' => 'Mobile App Key',
                            'key' => 'PAYSTACK_SECRET_KEY_PLACEHOLDER...',
                            'client' => 'BaronCast Mobile',
            ...
            <div class="modal-body">
                <form id="apiKeyForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="clientName" name="client" required placeholder="e.g., BaronCast Mobile App">
                    </div>
