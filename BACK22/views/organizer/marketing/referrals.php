        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="referralLink" value="https://baroncast.online/ref/your-unique-code" readonly>
...
function shareOnSocial(platform) {
    ...
    const message = "Check out BaronCast - the best platform for online voting events!";
    ...
    switch (platform) {
        ...
        case 'whatsapp':
            ...
            break;
        case 'email':
            shareUrl = `mailto:?subject=${encodeURIComponent('Check out BaronCast!')}&body=${encodeURIComponent(message + '\n\n' + referralLink)}`;
            break;
    }
...
function shareReferral() {
    if (navigator.share) {
        navigator.share({
            title: 'BaronCast Referral',
            text: 'Check out BaronCast - the best platform for online voting events!',
