            ...
            configForm = `
                <form id="stripeConfig">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="publishable_key" placeholder="Paystack public key">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Secret Key</label>
                        <input type="password" class="form-control" name="secret_key" placeholder="Paystack secret key">
                    </div>
                    <div class="mb-3">
            ...
            configForm = `
                <form id="s3Config">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="access_key" placeholder="AWS access key">
                    </div>
                    <div class="mb-3">
