        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    API keys allow external applications to access your BaronCast data. Keep them secure and never share them publicly.
                </div>
                ...
                <div class="api-key-item border rounded p-3 mb-3">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <div class="btn-group btn-group-sm">
                            <button class="btn btn-outline-secondary" onclick="copyAPIKey('PAYSTACK_SECRET_KEY_PLACEHOLDER')">
                                <i class="fas fa-copy"></i>
                            </button>
                            <button class="btn btn-outline-warning" onclick="regenerateAPIKey('PAYSTACK_SECRET_KEY_PLACEHOLDER')">
                                <i class="fas fa-sync"></i>
                            </button>
                            <button class="btn btn-outline-danger" onclick="revokeAPIKey('PAYSTACK_SECRET_KEY_PLACEHOLDER')">
