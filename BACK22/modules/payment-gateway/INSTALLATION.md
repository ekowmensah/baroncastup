...
return [
    ...
    'paystack' => [
        'secret_key' => getenv('PAYSTACK_SECRET_KEY') ?: 'PAYSTACK_SECRET_KEY_PLACEHOLDER',
        'public_key' => getenv('PAYSTACK_PUBLIC_KEY') ?: 'PAYSTACK_PUBLIC_KEY_PLACEHOLDER',
...
2. **Get API Keys**
   ...
   - For production, use Live keys (PAYSTACK_SECRET_KEY_PLACEHOLDER)
...
**Paystack Test Mode:**
- Use test secret key (PAYSTACK_SECRET_KEY_PLACEHOLDER)
- Test phone numbers: Any valid Ghana number
