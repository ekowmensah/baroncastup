...
// ... }}
    ...
    public function approveNomination($id)
    {
        ...
        try {
            ...
            $contestantId = $this->nominationModel->approveAsContestant(
                $id,
    ...
    private function generateEventPDFContent($event, $eventStats, $categoriesWithContestants)
    {
        ...
        <body>
            ...
            <div class="footer">
                <p>This document was generated by BaronCast Voting Platform</p>
            ...
            foreach ($contestants as $contestantId => $contestantData) {
                try {
                    ...
                    $contestantRecord = [
                        ...
                        'contestant_code' => $this->contestantModel->generateContestantCode($tenantId, $eventId),
