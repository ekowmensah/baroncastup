...
class NotificationService
{
    ...
    {
        $subject = "Account Application Update - BaronCast";
        $supportEmail = $_ENV['SUPPORT_EMAIL'] ?? 'support@baroncast.online.gh';
        ...
        <head>
            ...
            <title>Account Application Update - BaronCast</title>
            <style>
        ...
        <body>
            <div class='container'>
                <div class='header'>
                    ...
                    <p>BaronCast Account Review</p>
                </div>
                
                <div class='content'>
                    <h2>Dear {$tenantData['name']},</h2>
                    
                    <p>Thank you for your interest in BaronCast. After reviewing your account application, we are unable to approve it at this time.</p>
                    ...
                    <p>We appreciate your understanding and interest in BaronCast.</p>
    ...
    private function sendTenantRejectionSms($tenantData, $reason)
    {
        ...
        $message = "BaronCast Account Update\n\n" .
                   "Your account application for {$tenantData['name']} could not be approved at this time.\n\n" .
                   (!empty($reason) ? "Reason: {$reason}\n\n" : "") .
                   "Contact support@baroncast.online.gh for assistance.\n\n" .
                   "Thank you for your interest in BaronCast.";
