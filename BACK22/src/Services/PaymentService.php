    ...
    public function initializeMobileMoneyPayment($paymentData)
    {
        try {
            ...
            $gatewayData = [
                ...
                'reference' => $reference,
                'currency' => $paymentData['currency'] ?? 'GHS',
                'email' => $paymentData['email'] ?? 'voter@baroncast.online',
                'customer_name' => $paymentData['customer_name'] ?? 'BaronCast Voter',
                'name' => $paymentData['name'] ?? $paymentData['customer_name'] ?? 'BaronCast Voter',
                'description' => $paymentData['description'],
