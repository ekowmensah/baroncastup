...
class HubtelGateway
{
    ...
    public function initializeMobileMoneyPayment($data)
    {
        ...
        $paymentData = [
            'CustomerName' => $data['customer_name'] ?? 'BaronCast Voter',
            ...
            'Description' => $data['description'] ?? 'BaronCast Vote Payment',
    ...
    public function initializeCardPayment($data)
    {
        ...
        $paymentData = [
            ...
            'customerName' => $data['customer_name'] ?? 'BaronCast Voter',
            'customerEmail' => $data['email'] ?? 'voter@baroncast.online',
    ...
    private function generateEmailFromPhone($phone)
    {
        ...
        return "voter{$hash}@baroncast.online";
    }
